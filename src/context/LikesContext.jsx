...
//     //('📡 Fetching liked properties from API...');
...
//       //('⚠️ API returned error, using empty array');
//         dispatch({ type: 'SET_LIKED_PROPERTIES', payload: [] });
//         return;
//       }

//       if (!response.ok) {
//       //('❌ Response not OK, using empty array');
//         dispatch({ type: 'SET_LIKED_PROPERTIES', payload: [] });
//         return;
//       }
...
//       //('🎯 Setting liked properties:', likedIds);
...
//     } catch (error) {
//     //('❌ Error fetching liked properties (silent fail):', error.name);
...
//     //('📡 Toggle response status:', response.status);
