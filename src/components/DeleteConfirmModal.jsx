// src/components/admin/batches/DeleteConfirmModal.jsx
const DeleteConfirmModal = ({ isOpen, batch, onClose, onConfirm }) => {
          ...
          <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-2">
                ...
                {batch?.propertyUnits?.length > 0 && (
                  <p className="mt-2 text-sm text-red-600">
                    Warning: This batch contains {batch.propertyUnits.length} property units. Deleting will remove all associations.
                  </p>
                )}
              </div>
            </div>
