 ...
 <div className="bg-gradient-to-tl from-blue-50 via-white to-indigo-50 py-8 md:py-16">
  <div className="max-w-7xl mx-auto px-4">
    ...
    <div className="text-center mb-6 md:mb-12">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-2 md:gap-4 max-w-5xl mx-auto mb-6 md:mb-8">
        {[
          { label: "Total", value: stats.total, color: "gray" },
          { label: "Sale", value: stats.sale, color: "blue" },
          { label: "Rent", value: stats.rent, color: "green" },
          { label: "Lease", value: stats.lease, color: "purple" },
          { label: "PG", value: stats.pg, color: "orange" }
        ].map((stat) => (
          <div 
            key={stat.label}
    ...
    {/* Listing Type Selector - Compact mobile view */}
    ...
    <div className="mb-4 md:mb-8">
      <div className="bg-white rounded-lg md:rounded-xl p-3 md:p-6 shadow-sm mb-3 md:mb-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs md:text-sm font-medium">
              {stats[selectedType]} Available
            </span>
          </div>
        </div>
      </div>

      {/* Features for selected type - Compact on mobile */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4 mb-4 md:mb-8">
        {selectedType === "sale" && [
          { icon: Home, text: "Ownership", color: "blue" },
          { icon: TrendingUp, text: "Investment", color: "blue" },
          { icon: CheckCircle, text: "Permanent", color: "blue" }
        ].map((feature, index) => (
        ...
        {selectedType === "rent" && [
          { icon: Key, text: "Flexible", color: "green" },
          { icon: Clock, text: "Short term", color: "green" },
          { icon: Shield, text: "No maintenance", color: "green" }
        ].map((feature, index) => (
        ...
        {selectedType === "lease" && [
          ...
          { icon: Star, text: "Stability", color: "purple" }
        ].map((feature, index) => (
        ...
        {selectedType === "pg" && [
          { icon: Hotel, text: "PG Business", color: "orange" },
          { icon: Users, text: "Multi-room", color: "orange" },
          { icon: Coffee, text: "Kitchen", color: "orange" }
        ].map((feature, index) => (
          <div key={index} className="bg-orange-50 border border-orange-100 rounded-lg p-2 md:p-4 flex items-center gap-2">
            <feature.icon className="w-3 h-3 md:w-5 md:h-5 text-orange-600" />
    ...
    {/* CTA Section */}
    <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-lg md:rounded-2xl p-4 md:p-6 lg:p-8 text-white overflow-hidden">
