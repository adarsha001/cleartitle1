                ...
                >
                  ...
                  <Link to="/properties">
                    <motion.button
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="group w-full py-4 bg-white border-2 border-stone-200 text-stone-700 font-medium rounded-xl shadow-md hover:shadow-xl transition-all duration-300 text-base flex items-center justify-center gap-3 hover:border-amber-300"
                    >
